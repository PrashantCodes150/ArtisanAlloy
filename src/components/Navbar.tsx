                        ...
                        <div className="px-4 py-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-jewelry-gold/20">
                                <div className="flex items-center space-x-4">
                                    ...
                                    >
                                        <Heart className="w-5 h-5" />
                                        {wishlistCount > 0 && <span className="absolute -top-1 -right-1 w-4 h-4 bg-jewelry-rose rounded-full text-xs flex items-center justify-center text-white">{wishlistCount}</span>}
                                    </button>
                                    <button
                                        onClick={handleCartClick}
                                        className="p-2 text-jewelry-cream/80 hover:text-jewelry-gold relative"
                                    >
                                        <ShoppingCart className="w-5 h-5" />
                                        {cartCount > 0 && <span className="absolute -top-1 -right-1 w-4 h-4 bg-jewelry-rose rounded-full text-xs flex items-center justify-center text-white">{cartCount}</span>}
                                    </button>
                                </div>
                                {isAuthenticated ? (
